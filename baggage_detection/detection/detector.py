...
class DetectorTF2:
    ...
    def __init__(self, path_to_checkpoint, path_to_labelmap, class_id=None, threshold=0.5):
        ...
        categories = label_map_util.convert_label_map_to_categories(label_map, max_num_classes=63,
    ...
    def DetectFromImage(self, img):
        ...
        im_height, im_width, *args = image.size
    ...
    def DisplayDetections(self, image, boxes_list, det_time=None, **kwargs):
        ...
        cv2.imwrite(filename=f'label_{image_name}', img=img)
        # return f'label_{image_name}'
        return img